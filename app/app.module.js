...
const in_memory_data_service_1 = require('./models/in-memory-data.service');
const app_component_1 = require('./app.component');
const comment_component_1 = require('./ts/comment.component');
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, comment_component_1.CommentComponent],
